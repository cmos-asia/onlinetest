 ...
 * @see org.base.online.service.impl.TopicType
 */
@Service("topicTypeService")
public class TopicTypeServiceImpl extends BaseSpringServiceImpl implements
		ITopicTypeService {

	@Override
	public String save(Object entity) throws Exception {
		TopicType topicType = (TopicType) entity;
		return super.save(topicType).toString();
	}

	@Override
	public String saveorupdate(Object entity) throws Exception {
		TopicType topicType = (TopicType) entity;
		return super.saveorupdate(topicType).toString();
	}

	@Override
	public Integer update(IBaseEntity entity) throws Exception {
		TopicType topicType = (TopicType) entity;
		return super.update(topicType);
	}

	@Override
	public TopicType findTopicTypeById(Object id) throws Exception {
		return super.findById(id, TopicType.class);
	}
	...
	@Override
	public List<TopicType> findAllTopicTypes() throws Exception {
		Finder finder = new Finder();
		String tableName = ClassUtils.getTableNameByClass(TopicType.class);
		finder.append("select * from " + tableName);

		return super.findListDataByFinder(finder, null, TopicType.class, null);
	}
}
