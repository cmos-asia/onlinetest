...
public class TopicTypeController  extends BaseController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model,TopicType topicType) 
			throws Exception {
	...
	public @ResponseBody
	ReturnDatas listjson(HttpServletRequest request, Model model,TopicType topicType) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		// ==构造分页请求
		Page page = newPage(request);
		// ==执行分页查询
		List<TopicType> datas=topicTypeService.findListDataByFinder(null,page,TopicType.class,topicType);
	...
	public void listexport(HttpServletRequest request,HttpServletResponse response, Model model,TopicType topicType) throws Exception{
		// ==构造分页请求
		Page page = newPage(request);
	
		File file = topicTypeService.findDataExportExcel(null,listurl, page,TopicType.class,topicType);
	...
	public @ResponseBody
	ReturnDatas saveorupdate(Model model,TopicType topicType,HttpServletRequest request,HttpServletResponse response) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
