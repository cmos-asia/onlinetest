...
public class TestPaperController  extends BaseController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(HttpServletRequest request, Model model,TestPaper testPaper) 
			throws Exception {
	...
	public @ResponseBody
	ReturnDatas listjson(HttpServletRequest request, Model model,TestPaper testPaper) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		// ==构造分页请求
		Page page = newPage(request);
		// ==执行分页查询
		List<TestPaper> datas=testPaperService.findListDataByFinder(null,page,TestPaper.class,testPaper);
	...
	public void listexport(HttpServletRequest request,HttpServletResponse response, Model model,TestPaper testPaper) throws Exception{
		// ==构造分页请求
		Page page = newPage(request);
	
		File file = testPaperService.findDataExportExcel(null,listurl, page,TestPaper.class,testPaper);
	...
	public @ResponseBody
	ReturnDatas saveorupdate(Model model,TestPaper testPaper,HttpServletRequest request,HttpServletResponse response) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
