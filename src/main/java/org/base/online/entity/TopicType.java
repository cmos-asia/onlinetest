...
public class TopicType  extends BaseEntity {
	...
	//alias
	/*
	public static final String TABLE_ALIAS = "TopicType";
	public static final String ALIAS_ID = "题目类型表";
    ...
    */
	...
	public String toString() {
		return new StringBuffer()
			.append("题目类型表[").append(getId()).append("],")
	...
	public boolean equals(Object obj) {
		if(obj instanceof TopicType == false) return false;
