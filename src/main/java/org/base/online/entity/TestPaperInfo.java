...
public class TestPaperInfo  extends BaseEntity {
	...
	//alias
	/*
	public static final String TABLE_ALIAS = "TestPaperInfo";
	public static final String ALIAS_ID = "试卷详情表";
	public static final String ALIAS_PAPER_ID = "试卷ID";
	public static final String ALIAS_TOPIC_TYPE = "题目类型";
	public static final String ALIAS_SCORE = "分值";
	public static final String ALIAS_PROBLEM_DESCRIPTION = "题目描述";
	public static final String ALIAS_REFERENCE_DESCRIPTION = "参考说明";
	public static final String ALIAS_OPTION = "选项";
	public static final String ALIAS_RIGHT_ANSWER = "正确答案";
	public static final String ALIAS_CREATE_TIME = "创建日期";
	public static final String ALIAS_UPDATE_TIME = "修改日期";
	public static final String ALIAS_IMGURL = "图片路径";
	public static final String ALIAS_ISIMG = "是否为图片类型题目（0：否，1：是）";
    */
	//date formats
	...
	public void setOption(java.lang.String value) {
     ...
     @WhereSQL(sql="option=:TestPaperInfo_option")
	...
	public String toString() {
		return new StringBuffer()
			.append("试卷详情表[").append(getId()).append("],")
			.append("试卷ID[").append(getPaper_id()).append("],")
			.append("题目类型[").append(getTopic_type()).append("],")
			.append("分值[").append(getScore()).append("],")
			.append("题目描述[").append(getProblem_description()).append("],")
			.append("参考说明[").append(getReference_description()).append("],")
			.append("选项[").append(getOption()).append("],")
			.append("正确答案[").append(getRight_answer()).append("],")
			.append("创建日期[").append(getCreate_time()).append("],")
			.append("修改日期[").append(getUpdate_time()).append("],")
			.append("图片路径[").append(getImgURL()).append("],")
	...
	public boolean equals(Object obj) {
		if(obj instanceof TestPaperInfo == false) return false;
