...
public class TestRecord  extends BaseEntity {
	...
	//alias
	/*
	public static final String TABLE_ALIAS = "TestRecord";
	public static final String ALIAS_ID = "考试记录表";
	public static final String ALIAS_STUDENT_ID = "学生ID";
	public static final String ALIAS_PAPER_ID = "试题表ID";
	public static final String ALIAS_PAPER_NAME = "试题名称";
	public static final String ALIAS_USED_TIME = "做题使用时间";
	public static final String ALIAS_RIGHT_SCORE = "得分";
	public static final String ALIAS_ANSWER_START_TIME = "作答开始时间";
	public static final String ALIAS_ANSWER_FINISH_TIME = "作答结束时间";
	public static final String ALIAS_CREATE_TIME = "创建日期";
	public static final String ALIAS_UPDATE_TIME = "修改日期";
	public static final String ALIAS_STATUS = "状态（0：未做 1：已做）";
	public static final String ALIAS_ISPASS = "是否及格（0：否，1：是）";
    */
	//date formats
	//public static final String FORMAT_ANSWER_START_TIME = DateUtils.DATETIME_FORMAT;
	//public static final String FORMAT_ANSWER_FINISH_TIME = DateUtils.DATETIME_FORMAT;
	...
	public java.lang.Integer getRight_score() {
		...
		/*
	public String getanswer_start_timeString() {
		return DateUtils.convertDate2String(FORMAT_ANSWER_START_TIME, getanswer_start_time());
	}
	public void setanswer_start_timeString(String value) throws ParseException{
		setanswer_start_time(DateUtils.convertString2Date(FORMAT_ANSWER_START_TIME,value));
	}*/
	...
	public java.util.Date getAnswer_start_time() {
		...
		/*
	public String getanswer_finish_timeString() {
		return DateUtils.convertDate2String(FORMAT_ANSWER_FINISH_TIME, getanswer_finish_time());
	}
	public void setanswer_finish_timeString(String value) throws ParseException{
		setanswer_finish_time(DateUtils.convertString2Date(FORMAT_ANSWER_FINISH_TIME,value));
	}*/
	...
	public String toString() {
		return new StringBuffer()
			.append("考试记录表[").append(getId()).append("],")
	...
	public boolean equals(Object obj) {
		if(obj instanceof TestRecord == false) return false;
